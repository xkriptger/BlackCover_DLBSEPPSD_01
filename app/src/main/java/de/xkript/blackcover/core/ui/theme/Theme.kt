...
// Extension colors Light
val ColorScheme.black: Color
    get() = if (true) Black else Black

val ColorScheme.white: Color
    get() = if (true) White else White

val ColorScheme.yellow: Color
    get() = if (true) Yellow else Yellow

val ColorScheme.gray: Color
    get() = if (true) Gray else Gray

val ColorScheme.backModal: Color
    get() = if (true) BackModal else BackModal
